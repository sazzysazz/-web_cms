                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table" border="1px">
                                        ...
                                        <tr>
                                            ...
                                            <td>27/June/2022</td>
                                            <td width="150px">
                                                <a href=""class="btn btn-primary" style="border-radius: 10px;" >Update</a>
                                                <button type="button" remove-id="3" style="border-radius: 10px;" class="btn btn-danger btn-remove" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                    Remove
                                                </button>
                                            </td>
                                        </tr>
